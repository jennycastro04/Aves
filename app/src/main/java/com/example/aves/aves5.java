...
public class aves5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aves5);

        spinner = findViewById(R.id.spinnerave5);
        btnsonido = findViewById(R.id.imgave5);
        ...
        btnsonido = (ImageButton) findViewById(R.id.imgave5);
        mp = MediaPlayer.create(this, R.raw.doliornisremseni);
    ...
    public void pausarave5(View view){
        mp.stop();
    }

    public void buscar5(View view){
