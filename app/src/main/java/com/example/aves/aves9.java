...
public class aves9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aves9);

        spinner = findViewById(R.id.spinnerave9);
        btnsonido = findViewById(R.id.imgave9);
        ...
        btnsonido = (ImageButton) findViewById(R.id.imgave9);
        mp = MediaPlayer.create(this, R.raw.rallussemiplumbeus);
    ...
    public void pausarave9(View view){

        mp.stop();
    }

    public void buscar9(View view){
